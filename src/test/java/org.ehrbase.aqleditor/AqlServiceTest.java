...
public class AqlServiceTest {
  ...
  public void shouldCorrectlyValidateAql2() {
    ...
    assertThat(response.getStartLine(), is("1"));
    assertThat(response.getMessage(),
            containsStringIgnoringCase("Parse exception: line 1: char 23 mismatched input 'where' expecting {NULL, STRING_FUNCTION_ID, NUMERIC_FUNCTION_ID, DATE_TIME_FUNCTION_ID, COUNT, MIN, MAX, SUM, AVG, TERMINOLOGY, IDENTIFIER, BOOLEAN, INTEGER, REAL, SCI_INTEGER, SCI_REAL, DATE, TIME, DATETIME, STRING, '-'}"));
    assertThat(response.getError(),
            containsStringIgnoringCase("mismatched input 'where' expecting {NULL, STRING_FUNCTION_ID, NUMERIC_FUNCTION_ID, DATE_TIME_FUNCTION_ID, COUNT, MIN, MAX, SUM, AVG, TERMINOLOGY, IDENTIFIER, BOOLEAN, INTEGER, REAL, SCI_INTEGER, SCI_REAL, DATE, TIME, DATETIME, STRING, '-'}"));
  }
